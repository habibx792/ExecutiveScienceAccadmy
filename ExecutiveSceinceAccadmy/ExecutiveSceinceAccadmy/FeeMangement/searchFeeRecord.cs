...
{
    public partial class searchFeeRecord : Form
    {
        public searchFeeRecord()
        {
            InitializeComponent();
        ...
        private void StyleControls()
        {
            ...
            UI.Instance.StyleButtonWidthHeight(btnSearch,50,150, borderRadius: 20);
        }
        ...
        private void searchFeeRecord_Load(object sender, EventArgs e)
        {
